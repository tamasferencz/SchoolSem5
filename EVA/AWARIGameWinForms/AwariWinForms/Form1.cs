    ...
    public partial class Awari : Form
    {
       ...
       // private int lastSize;
        ...
        private void InitializeComponent()
        {
            ...
            menuStrip.Size = new Size(1900, 24);
            ...
            _menuFileNewGame.Size = new Size(134, 22);
            ...
            _menuFileLoadGame.Size = new Size(134, 22);
            ...
            _menuFileSaveGame.Size = new Size(134, 22);
            ...
            _menuFileExit.Size = new Size(134, 22);
            ...
            _menuGameEasy.Size = new Size(136, 22);
            ...
            _menuGameMedium.Size = new Size(136, 22);
            ...
            _menuGameHard.Size = new Size(136, 22);
            ...
            label2.Location = new Point(864, 377);
            label2.Name = "label2";
            ...
            label3.Location = new Point(890, 330);
            label3.Name = "label3";
            label3.Size = new Size(45, 37);
            label3.TabIndex = 3;
            label3.Text = "to";
            // 
            // Awari
            // 
            ClientSize = new Size(1900, 800);
            Controls.Add(label3);
            Controls.Add(label2);
            Controls.Add(label1);
        ...
        private void MenuFileNewGame_Click(object? sender, EventArgs e)
        {
            ...
            StartNewGameWithDifficulty(LastSize);
        }
        ...
        private void StartNewGameWithDifficulty(int numberOfPits)
        {
            ...
            gameForm = new AwariModel(numberOfPits, persistence);
        ...
        private void MenuFileSaveGame_Click(object? sender, EventArgs e)
        {
            using (SaveFileDialog saveFileDialog = new SaveFileDialog())
            {
                ...
                {
                    gameForm!.GameModel.SaveGame(saveFileDialog.FileName);
                }
            }
        ...
        private void MenuFileLoadGame_Click(object? sender, EventArgs e)
        {
            ...
            using (OpenFileDialog openFileDialog = new OpenFileDialog())
            {
                ...
                if (openFileDialog.ShowDialog() == DialogResult.OK)
                {
                    ...
                    var persistence = new GamePersistence();
                    int numberOfPits = gameForm!.GameModel.LoadGame(openFileDialog.FileName);
                    
                    gameForm = new AwariModel(numberOfPits, persistence);
                    gameForm.SetNumberOfPits(numberOfPits);
                    gameForm.GameModel.LoadGame(openFileDialog.FileName);
