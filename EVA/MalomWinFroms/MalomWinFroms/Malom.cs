...
namespace MalomWinForms
{
    public class Malom : Form
    {
        ...
        private void InitUI()
        {
            ...
            saveBtn.Click += (s, e) =>
            {
                game.SaveGameModel("save.txt", game.Board, game.CurrentPlayer, game.Placed1, game.Placed2, game.RemovingMode);
            ...
            loadBtn.Click += (s, e) =>
            {
                var state = game.LoadGameModel("save.txt");
