...
namespace MalomModel
{
    public class GameModel
    {
        ...
        public void SetState(int[] board, int currentPlayer, int placed1, int placed2, bool removingMode)
        {
            if (board.Length != 24)
                throw new ArgumentException("A tábla mérete 24 mező kell legyen.");
        ...
        {
            return persistence.LoadGame(path);
        }
    }
}
